...
export const DISCLAIMERS = {
  ...
  STATIC_DATA: "⚠️ 본 데이터는 실시간 API가 아닌 업종별 통계 평균치 기반입니다. 참고용으로만 활용하시고, 실제 창업 시에는 현장 조사 및 전문가 상담을 권장합니다.",
  RENT_ESTIMATE: "⚠️ 임대료 시세는 국토부 통계 및 업계 평균 기반 추정치입니다. 실제 임대료는 건물 상태, 권리금, 임대인 협상에 따라 ±30% 이상 차이날 수 있습니다.",
  REVENUE_ESTIMATE: "⚠️ 매출 시뮬레이션은 업종별 평균 데이터 기반 추정치입니다. 실제 매출은 운영 역량, 마케팅, 상권 변화에 따라 크게 달라집니다.",
} as const;
